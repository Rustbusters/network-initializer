<script lang="ts">
    ...
    function handleEmoji(emoji: string) {
        ...
        inputValue = inputValue.slice(0, cursorPos) + emoji + inputValue.slice(cursorPos);
...
<div class="w-full h-[450px] flex flex-col">
    <div
        ...
        class="chat-box h-full overflow-y-auto space-y-4 p-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700"
    >
        {#each $messages[clientId] || [] as msg}
